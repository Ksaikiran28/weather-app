const apiKey="964257e08fba28a4ac34b32bd97dfeaf";
...
async function getWeatherData(cityValue){
    try {
        ...
        const descriptionE = data.weather[0].description;
        ...
        weatherDataEl.querySelector(".description").textContent=`${descriptionE}`;
